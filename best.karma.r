# Função que testa todos os possiveis modelos de uma KARMA e retorna o melhor modelo
# segundo o criterio de AIC.
#
# Implementado por Fabio M Bayer (bayer@ufsm.br) em 02/10/2014
#
# Alterado por Renata R Guerra (renata.r.guerra@ufsm.br) em 13/11/2018
# Dados de entrada:
  ...
  { 
    ...
    { 
      ...
      {   
        ...
        if(aicmin>fitkarma$aic) # melhor modelo segundo o AIC
        {  
          aicmin<-fitkarma$aic
